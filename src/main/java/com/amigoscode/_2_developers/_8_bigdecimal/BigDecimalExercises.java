...
public class BigDecimalExercises {
    ...
    public static void demonstrateDoubleProblem() {
        ...
        System.out.println("The string constructor should be preferred when using BigDecimal: Binary floating numbers like double cannot precisely" +
                "represent values like 0.1, passing a double to the constructor passes an imprecise binary representation" +
                " Always us the string constructor to achieve exact accuracy");
