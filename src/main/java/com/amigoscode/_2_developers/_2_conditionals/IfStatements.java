...
public class IfStatements {
    ...
    public static boolean isEligibleForLoan(int age, double income, boolean hasGuarantor) {
        ...
        //boolean Decision = (age >= 18 && income >= 30000) || (hasGuarantor && age >= 16);
    ...
    public static boolean safeEquals(String a, String b) {
        ...
        //if both strings are null, they are equal. If only one is null evaluating .equals
        //will crash, so handle nulls safely before checking content
