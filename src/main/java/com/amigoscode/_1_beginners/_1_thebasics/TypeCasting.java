...
public class TypeCasting {
    ...
    public static void main(String[] args) {
        ...
        int asciiCode = 65;
        char representedChar = (char) asciiCode;
        System.out.println(asciiCode + " = " + representedChar);
        ...
        char targetChar = 'Z';
        int extractedAscii = (int) targetChar;
        System.out.println(targetChar + " = " + extractedAscii);
        ...
        int baseNumber = 42;
        String convertedString = String.valueOf(baseNumber);
